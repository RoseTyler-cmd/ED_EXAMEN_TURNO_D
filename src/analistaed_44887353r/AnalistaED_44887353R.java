...
public class AnalistaED_44887353R {

    static final double FACTOR_HORA_EXTRA = 1.2;
    private String nombreCompleto, dni;
    private double salarioBasePorHora = 10.56;

    public AnalistaED_44887353R(String nombreCompleto, String dni) {
    ...
    public static void main(String[] args) {
        ...
        AnalistaED_44887353R emp = new AnalistaED_44887353R("SERGIO BADAL", "44654545X");
        int horasExtra = 2;
